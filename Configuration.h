...
#define EXTRUDER_GAIN 0.018
#define UNDER_LIMIT 5
#define MAXR 61.23378284084693
...
#ifndef MOTHERBOARD
#define MOTHERBOARD 80 // R-360 35 Single Extruder , 36 Dual Head
#endif
...
#define HOMING_FEEDRATE {10*60, 60*60, 5*60, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {133.33333333,20.47315742,133,33333333,327.1089} //e:720 wades  //79.5355// default steps per unit for (R-360 Y 15.9431734297273 calculated)R_360_STEPS_PER_ROTATION/(PI*2)
#define DEFAULT_MAX_FEEDRATE          {300, 1200, 50, 25}    // (mm/sec)
